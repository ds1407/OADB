<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractProfile.aspx.cs" Inherits="OADB.ContractProfile" MasterPageFile="OADB.Master" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table style="width: 800px">
        <tr>
            <td class="PageHeader">Contract Profile</td>
    ...
    <table style="width: 800px; border: 1px solid black">
        ...
        <tr>
            <td style="width: 50%" class="label">Contract Number</td>
            <td style="width: 50%" class="label">Order Number</td>
        </tr>
        <tr>
            <td>
                <asp:TextBox ID="ContractNumber" runat="server" Width="300px" CssClass="textboxReadOnly" ReadOnly="True"></asp:TextBox>
            </td>
            <td>
